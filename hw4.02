...
OBSTACLE_LOOP
	CMP r8, #3				; If already at the left boundary, do not move
	MOVLE pc,r14		;return to main program
	ADD r11,r10,r8			; Position of "@"
	LDRB r0,[r11]			; Store "@" in r0
	STRB r9,[r11]			; Write " " to r2
	SUB r8,r8,#3			; Move "@" 3 positions to the left
	ADD r11,r10,r8
	STRB r0,[r11]		
